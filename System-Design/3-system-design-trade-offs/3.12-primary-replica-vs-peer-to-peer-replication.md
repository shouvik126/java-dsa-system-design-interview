...
permalink: /System-Design/3-system-design-trade-offs/3.12-primary-replica-vs-peer-to-peer-replication/
prev_title: "SQL vs. NoSQL"
prev_url: "/System-Design/3-system-design-trade-offs/3.11-sql-vs-nosql/"
next_title: "Data Compression vs. Data Deduplication"
next_url: "/System-Design/3-system-design-trade-offs/3.13-data-compression-vs-data-deduplication/"
---
...
![Primary Replica Replication Architecture](assets/3.12-primary-replica-replication.png)
...
![Peer to Peer Replication Architecture](assets/3.12-peer-to-peer-replication.png)
...
| **Data Flow** | Unidirectional (Primary $\rightarrow$ Replicas). | Multi-directional (Peers $\leftrightarrow$ Peers). |
