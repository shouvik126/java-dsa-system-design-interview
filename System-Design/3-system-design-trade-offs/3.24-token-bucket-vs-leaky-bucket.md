...
![The same burst through both limiters — Token bucket lets requests through immediately; leaky bucket releases them at a steady rate](assets/3.24-token-bucket-vs-leaky-bucket.png)
