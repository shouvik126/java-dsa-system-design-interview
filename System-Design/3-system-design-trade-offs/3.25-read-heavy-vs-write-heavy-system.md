...
![Read-heavy vs write-heavy architecture — caches, CDN and replicas for read-heavy; queues and batching for write-heavy](assets/3.25-read-heavy-vs-write-heavy-system.png)
