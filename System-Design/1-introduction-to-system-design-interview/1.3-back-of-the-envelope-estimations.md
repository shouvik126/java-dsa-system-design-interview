...
*   **Daily Posts**: 100 million DAU × 10 posts/user = 1 billion posts/day
*   **Average Write QPS**: 1 billion posts / 86,400 seconds/day ≈ 11,574 requests/second
*   **Peak QPS**: ≈ 11,574 × 2 ≈ 23,000 requests/second
...
*   **Daily Storage Requirement**: 500 million users × 2 uploads/day × 2 MB/photo = 2,000,000,000 MB/day = 2 TB/day

### 3. Bandwidth Estimation
For a streaming app serving 10 million active users streaming 1080p video at an average bitrate of 4 Mbps.

*   **Total Outgoing Bandwidth**: 10 million users × 4 Mbps = 40,000,000 Mbps = 40 Tbps
...
*   **Sequential Latency**: 50 ms + 100 ms + 200 ms = 350 ms
*   **Parallel Latency (if concurrent)**: max(50 ms, 100 ms, 200 ms) = 200 ms

### 5. Resource Estimation
A service receives 10,000 requests per second. Each request consumes 10 ms of CPU thread time.

*   **Total CPU Time Required Per Second**: 10,000 requests/sec × 10 ms/request = 100,000 ms/sec
*   **Required CPU Cores**: 100,000 ms/sec / 1,000 ms per core-sec = 100 cores
