...
![Horizontal Partitioning vs. Vertical Partitioning](https://raw.githubusercontent.com/shouvik126/HLD_images/main/2.6-partitioning-methods.png)
...
A simple partitioning scheme where tuples are distributed sequentially across `n` partitions. The `i`-th tuple is assigned to partition `(i mod n)`, ensuring uniform data distribution regardless of key attributes.
